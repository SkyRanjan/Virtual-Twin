...
if (DID_API.key == 'bWFtbXlsb2xpYW51QGdtYWlsLmNvbQ:2Bb1KDlp9aPmhiXP3_Z-1');
  ...
  const createAgent = await axios.post('/agents',
    {
      ...
      "presenter": {
        ...
        "thumbnail": "https://drive.google.com/uc?export=download&id=1eqTxYZNcu4fMTo3ba1g0EgJrXZxvwiF6",
        "source_url": "https://drive.google.com/uc?export=download&id=1eqTxYZNcu4fMTo3ba1g0EgJrXZxvwiF6"
      },
      "llm": {
        "type": "openai",
        "provider": "openai",
        "model": "gpt-4",
        "instructions": "Your name is Emma, a virutal AI assistant. You are a friendly and informative doctor. You are here to help the user with their questions about the preoperational procedure. The procedure is a heart bypass surgery. You are here to help the user with their questions about the procedure. Please answer the user's questions in a friendly manner.",
